...
# ── 多國語系 ────────────────────────────────────────────────────────────
LANG = os.environ.get("HERMES_LANG", "en").lower().replace("-", "_")
_lang_map = {"zh_tw": "zh_tw", "zh_cn": "zh_cn", "zh_hk": "zh_tw",
             "en": "en", "de": "de", "ja": "ja", "it": "it",
             "fr": "fr", "es": "es", "ko": "ko"}
LANG = _lang_map.get(LANG, "en")

_STR = {
    # English — fallback: return key itself
    "en": {},
    # Traditional Chinese
    "zh_tw": {
        "backup": "備份",
        ...
        "cancel": "取消",
        "package": "套件",
        "Scanning {path} ...": "掃描 {path} ...",
        "No files to backup": "沒有檔案可打包",
        "Packaging {count} files ...": "打包 {count} 個檔案 ...",
        "Backup complete: {path}": "打包完成: {path}",
        "Files: {count}": "檔案數: {count}",
        "Original size: {size}": "原始大小: {size}",
        "Compressed size: {size}": "壓縮大小: {size}",
        "Compression ratio: {ratio}%": "壓縮率: {ratio}%",
        "Time: {elapsed}s": "耗時: {elapsed}s",
        "Sensitive files: {status}": "含敏感檔: {status}",
        "Restore with: hermes-transfer.py restore {name}": "還原指令: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "還原完成: {count} 個檔案，耗時 {elapsed}s",
        "Integrity check: {verified}/{total} passed": "完整性驗證: {verified}/{total} 通過",
        "Warning: {count} errors": "警告 ({count}):",
        "Deploying to {host}": "回生部署: {host}",
        "Testing SSH connection to {host}...": "測試 SSH 連線到 {host} ...",
        "SSH connection failed": "SSH 連線失敗",
        "SSH connected successfully": "SSH 連線成功",
        "Detecting remote environment...": "偵測遠端環境 ...",
        "Hermes not installed": "未安裝 Hermes",
        "Installing Hermes...": "正在安裝 Hermes Agent ...",
        "Installation failed": "安裝失敗",
        "Transferring package...": "傳送套件到 {host} ...",
        "Transfer complete ({size})": "已傳送 ({size})",
        "Remote restore failed": "遠端還原失敗",
        "Deployment complete!": "回生部署完成！",
        "Target '{name}' does not exist": "目標 '{name}' 不存在",
        "Target '{name}' added: {host}": "目標 '{name}' 已新增: {host}",
        "No targets registered": "尚未註冊任何目標",
        "Registered targets ({count}):": "已註冊目標 ({count}):",
        "Starting Web GUI...": "啟動 Web GUI ...",
        "GUI available at http://{host}:{port}": "GUI 位於 http://{host}:{port}",
        "Input your SSH key path": "輸入 SSH 金鑰路徑",
        "Input your remote host": "輸入遠端主機",
        "Skip sensitive files": "跳過敏感檔案",
        "Exclude .env and auth.json": "排除 .env 和 auth.json",
        "Preview mode --dry-run": "模擬模式 --dry-run",
        "Would restore {count} files": "將還原 {count} 個檔案",
        "No files will be written": "不會實際寫入任何檔案",
        "Run without --dry-run to execute": "移除 --dry-run 參數以執行還原",
    },
    # Simplified Chinese
    "zh_cn": {
        "backup": "备份",
        ...
        "No files to backup": "没有文件可打包",
        "Packaging {count} files ...": "打包 {count} 个文件 ...",
        "Backup complete: {path}": "打包完成: {path}",
        "Files: {count}": "文件数: {count}",
        "Original size: {size}": "原始大小: {size}",
        "Compressed size: {size}": "压缩大小: {size}",
        "Compression ratio: {ratio}%": "压缩率: {ratio}%",
        "Time: {elapsed}s": "耗时: {elapsed}s",
        "Sensitive files: {status}": "含敏感文件: {status}",
        "Restore with: hermes-transfer.py restore {name}": "还原命令: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "还原完成: {count} 个文件，耗时 {elapsed}s",
        "Integrity check: {verified}/{total} passed": "完整性验证: {verified}/{total} 通过",
        "Warning: {count} errors": "警告 ({count}):",
        "Deploying to {host}": "部署到 {host}",
        "Testing SSH connection to {host}...": "测试 SSH 连接到 {host} ...",
        "SSH connection failed": "SSH 连接失败",
        "SSH connected successfully": "SSH 连接成功",
        "Detecting remote environment...": "检测远程环境 ...",
        "Hermes not installed": "未安装 Hermes",
        "Installing Hermes...": "正在安装 Hermes Agent ...",
        "Installation failed": "安装失败",
        "Transferring package...": "传输包到 {host} ...",
        "Transfer complete ({size})": "已传输 ({size})",
        "Remote restore failed": "远程还原失败",
        "Deployment complete!": "部署完成！",
        "Target '{name}' does not exist": "目标 '{name}' 不存在",
        "Target '{name}' added: {host}": "目标 '{name}' 已添加: {host}",
        "No targets registered": "尚未注册任何目标",
        "Registered targets ({count}):": "已注册目标 ({count}):",
        "Starting Web GUI...": "启动 Web GUI ...",
        "GUI available at http://{host}:{port}": "GUI 位于 http://{host}:{port}",
        "Input your SSH key path": "输入 SSH 密钥路径",
        "Input your remote host": "输入远程主机",
        "Skip sensitive files": "跳过敏感文件",
        "Exclude .env and auth.json": "排除 .env 和 auth.json",
        "Preview mode --dry-run": "模拟模式 --dry-run",
        "Would restore {count} files": "将还原 {count} 个文件",
        "No files will be written": "不会实际写入任何文件",
        "Run without --dry-run to execute": "移除 --dry-run 参数以执行还原",
    },
    # German
    "de": {
        "backup": "Sicherung",
        ...
        "cancel": "Abbrechen",
        "package": "Paket",
        "Scanning {path} ...": "Durchsuche {path} ...",
        "No files to backup": "Keine Dateien zu sichern",
        "Packaging {count} files ...": "Verpacke {count} Dateien ...",
        "Backup complete: {path}": "Sicherung abgeschlossen: {path}",
        "Files: {count}": "Dateien: {count}",
        "Original size: {size}": "Ursprüngliche Größe: {size}",
        "Compressed size: {size}": "Komprimierte Größe: {size}",
        "Compression ratio: {ratio}%": "Kompressionsrate: {ratio}%",
        "Time: {elapsed}s": "Zeit: {elapsed}s",
        "Sensitive files: {status}": "Sensible Dateien: {status}",
        "Restore with: hermes-transfer.py restore {name}": "Wiederherstellen mit: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "Wiederherstellung abgeschlossen: {count} Dateien in {elapsed}s",
        "Integrity check: {verified}/{total} passed": "Integritätsprüfung: {verified}/{total} bestanden",
        "Warning: {count} errors": "Warnung ({count}):",
        "Deploying to {host}": "Bereitstellung auf {host}",
        "Testing SSH connection to {host}...": "Teste SSH-Verbindung zu {host} ...",
        "SSH connection failed": "SSH-Verbindung fehlgeschlagen",
        "SSH connected successfully": "SSH erfolgreich verbunden",
        "Detecting remote environment...": "Erkennung der entfernten Umgebung ...",
        "Hermes not installed": "Hermes nicht installiert",
        "Installing Hermes...": "Installiere Hermes Agent ...",
        "Installation failed": "Installation fehlgeschlagen",
        "Transferring package...": "Übertrage Paket an {host} ...",
        "Transfer complete ({size})": "Übertragen ({size})",
        "Remote restore failed": "Fernwiederherstellung fehlgeschlagen",
        "Deployment complete!": "Bereitstellung abgeschlossen!",
        "Target '{name}' does not exist": "Ziel '{name}' existiert nicht",
        "Target '{name}' added: {host}": "Ziel '{name}' hinzugefügt: {host}",
        "No targets registered": "Keine Ziele registriert",
        "Registered targets ({count}):": "Registrierte Ziele ({count}):",
        "Starting Web GUI...": "Starte Web-GUI ...",
        "GUI available at http://{host}:{port}": "GUI verfügbar unter http://{host}:{port}",
        "Input your SSH key path": "SSH-Schlüsselpfad eingeben",
        "Input your remote host": "Remote-Host eingeben",
        "Skip sensitive files": "Sensible Dateien überspringen",
        "Exclude .env and auth.json": ".env und auth.json ausschließen",
        "Preview mode --dry-run": "Vorschaumodus --dry-run",
        "Would restore {count} files": "Würde {count} Dateien wiederherstellen",
        "No files will be written": "Keine Dateien werden geschrieben",
        "Run without --dry-run to execute": "Ohne --dry-run ausführen",
    },
    # Japanese
    "ja": {
        "backup": "バックアップ",
        ...
        "No files to backup": "バックアップするファイルがありません",
        "Packaging {count} files ...": "{count} 個のファイルをパッケージ化中 ...",
        "Backup complete: {path}": "パッケージ化完了: {path}",
        "Files: {count}": "ファイル数: {count}",
        "Original size: {size}": "元のサイズ: {size}",
        "Compressed size: {size}": "圧縮サイズ: {size}",
        "Compression ratio: {ratio}%": "圧縮率: {ratio}%",
        "Time: {elapsed}s": "時間: {elapsed}s",
        "Sensitive files: {status}": "機密ファイル: {status}",
        "Restore with: hermes-transfer.py restore {name}": "復元コマンド: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "復元完了: {count} ファイル、{elapsed}s",
        "Integrity check: {verified}/{total} passed": "整合性チェック: {verified}/{total} 合格",
        "Warning: {count} errors": "警告 ({count}):",
        "Deploying to {host}": "{host} にデプロイ",
        "Testing SSH connection to {host}...": "{host} への SSH 接続をテスト中 ...",
        "SSH connection failed": "SSH 接続に失敗しました",
        "SSH connected successfully": "SSH 接続に成功しました",
        "Detecting remote environment...": "リモート環境を検出中 ...",
        "Hermes not installed": "Hermes がインストールされていません",
        "Installing Hermes...": "Hermes Agent をインストール中 ...",
        "Installation failed": "インストールに失敗しました",
        "Transferring package...": "パッケージを {host} に転送中 ...",
        "Transfer complete ({size})": "転送完了 ({size})",
        "Remote restore failed": "リモート復元に失敗しました",
        "Deployment complete!": "デプロイ完了！",
        "Target '{name}' does not exist": "ターゲット '{name}' は存在しません",
        "Target '{name}' added: {host}": "ターゲット '{name}' を追加しました: {host}",
        "No targets registered": "ターゲットが登録されていません",
        "Registered targets ({count}):": "登録済みターゲット ({count}):",
        "Starting Web GUI...": "Web GUI を起動中 ...",
        "GUI available at http://{host}:{port}": "GUI: http://{host}:{port}",
        "Input your SSH key path": "SSH 鍵のパスを入力",
        "Input your remote host": "リモートホストを入力",
        "Skip sensitive files": "機密ファイルをスキップ",
        "Exclude .env and auth.json": ".env と auth.json を除外",
        "Preview mode --dry-run": "プレビューモード --dry-run",
        "Would restore {count} files": "{count} 個のファイルを復元します",
        "No files will be written": "ファイルは書き込まれません",
        "Run without --dry-run to execute": "--dry-run なしで実行してください",
    },
    # Italian
    "it": {
        "backup": "Backup",
        ...
        "cancel": "Annulla",
        "package": "Pacchetto",
        "Scanning {path} ...": "Scansione {path} ...",
        "No files to backup": "Nessun file da impacchettare",
        "Packaging {count} files ...": "Impacchetto {count} file ...",
        "Backup complete: {path}": "Impacchettamento completato: {path}",
        "Files: {count}": "File: {count}",
        "Original size: {size}": "Dimensione originale: {size}",
        "Compressed size: {size}": "Dimensione compressa: {size}",
        "Compression ratio: {ratio}%": "Rapporto compressione: {ratio}%",
        "Time: {elapsed}s": "Tempo: {elapsed}s",
        "Sensitive files: {status}": "File sensibili: {status}",
        "Restore with: hermes-transfer.py restore {name}": "Ripristina con: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "Ripristino completato: {count} file in {elapsed}s",
        "Integrity check: {verified}/{total} passed": "Controllo integrità: {verified}/{total} superati",
        "Warning: {count} errors": "Avviso ({count}):",
        "Deploying to {host}": "Distribuzione su {host}",
        "Testing SSH connection to {host}...": "Prova connessione SSH a {host} ...",
        "SSH connection failed": "Connessione SSH fallita",
        "SSH connected successfully": "Connessione SSH riuscita",
        "Detecting remote environment...": "Rilevamento ambiente remoto ...",
        "Hermes not installed": "Hermes non installato",
        "Installing Hermes...": "Installazione Hermes Agent ...",
        "Installation failed": "Installazione fallita",
        "Transferring package...": "Trasferimento pacchetto a {host} ...",
        "Transfer complete ({size})": "Trasferito ({size})",
        "Remote restore failed": "Ripristino remoto fallito",
        "Deployment complete!": "Distribuzione completata!",
        "Target '{name}' does not exist": "Destinazione '{name}' inesistente",
        "Target '{name}' added: {host}": "Destinazione '{name}' aggiunta: {host}",
        "No targets registered": "Nessuna destinazione registrata",
        "Registered targets ({count}):": "Destinazioni registrate ({count}):",
        "Starting Web GUI...": "Avvio Web GUI ...",
        "GUI available at http://{host}:{port}": "GUI disponibile su http://{host}:{port}",
        "Input your SSH key path": "Inserisci il percorso della chiave SSH",
        "Input your remote host": "Inserisci l'host remoto",
        "Skip sensitive files": "Salta file sensibili",
        "Exclude .env and auth.json": "Escludi .env e auth.json",
        "Preview mode --dry-run": "Modalità anteprima --dry-run",
        "Would restore {count} files": "Ripristinerà {count} file",
        "No files will be written": "Nessun file verrà scritto",
        "Run without --dry-run to execute": "Esegui senza --dry-run per procedere",
    },
    # French
    "fr": {
        "backup": "Sauvegarde",
        ...
        "No files to backup": "Aucun fichier à empaqueter",
        "Packaging {count} files ...": "Empaquetage de {count} fichiers ...",
        "Backup complete: {path}": "Empaquetage terminé : {path}",
        "Files: {count}": "Fichiers : {count}",
        "Original size: {size}": "Taille originale : {size}",
        "Compressed size: {size}": "Taille compressée : {size}",
        "Compression ratio: {ratio}%": "Taux de compression : {ratio}%",
        "Time: {elapsed}s": "Temps : {elapsed}s",
        "Sensitive files: {status}": "Fichiers sensibles : {status}",
        "Restore with: hermes-transfer.py restore {name}": "Restaurer avec : hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "Restauration terminée : {count} fichiers en {elapsed}s",
        "Integrity check: {verified}/{total} passed": "Vérification d'intégrité : {verified}/{total} réussis",
        "Warning: {count} errors": "Avertissement ({count}) :",
        "Deploying to {host}": "Déploiement vers {host}",
        "Testing SSH connection to {host}...": "Test de la connexion SSH à {host} ...",
        "SSH connection failed": "Connexion SSH échouée",
        "SSH connected successfully": "Connexion SSH réussie",
        "Detecting remote environment...": "Détection de l'environnement distant ...",
        "Hermes not installed": "Hermes non installé",
        "Installing Hermes...": "Installation d'Hermes Agent ...",
        "Installation failed": "Installation échouée",
        "Transferring package...": "Transfert du paquet vers {host} ...",
        "Transfer complete ({size})": "Transféré ({size})",
        "Remote restore failed": "Restauration distante échouée",
        "Deployment complete!": "Déploiement terminé !",
        "Target '{name}' does not exist": "La cible '{name}' n'existe pas",
        "Target '{name}' added: {host}": "Cible '{name}' ajoutée : {host}",
        "No targets registered": "Aucune cible enregistrée",
        "Registered targets ({count}):": "Cibles enregistrées ({count}) :",
        "Starting Web GUI...": "Lancement de l'interface Web ...",
        "GUI available at http://{host}:{port}": "Interface disponible sur http://{host}:{port}",
        "Input your SSH key path": "Entrez le chemin de votre clé SSH",
        "Input your remote host": "Entrez votre hôte distant",
        "Skip sensitive files": "Ignorer les fichiers sensibles",
        "Exclude .env and auth.json": "Exclure .env et auth.json",
        "Preview mode --dry-run": "Mode aperçu --dry-run",
        "Would restore {count} files": "Restaurerait {count} fichiers",
        "No files will be written": "Aucun fichier ne sera écrit",
        "Run without --dry-run to execute": "Exécutez sans --dry-run pour appliquer",
    },
    # Spanish
    "es": {
        "backup": "Respaldo",
        ...
        "No files to backup": "No hay archivos para empaquetar",
        "Packaging {count} files ...": "Empaquetando {count} archivos ...",
        "Backup complete: {path}": "Empaquetado completo: {path}",
        "Files: {count}": "Archivos: {count}",
        "Original size: {size}": "Tamaño original: {size}",
        "Compressed size: {size}": "Tamaño comprimido: {size}",
        "Compression ratio: {ratio}%": "Tasa de compresión: {ratio}%",
        "Time: {elapsed}s": "Tiempo: {elapsed}s",
        "Sensitive files: {status}": "Archivos sensibles: {status}",
        "Restore with: hermes-transfer.py restore {name}": "Restaurar con: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "Restauración completa: {count} archivos en {elapsed}s",
        "Integrity check: {verified}/{total} passed": "Verificación de integridad: {verified}/{total} aprobados",
        "Warning: {count} errors": "Advertencia ({count}):",
        "Deploying to {host}": "Desplegando en {host}",
        "Testing SSH connection to {host}...": "Probando conexión SSH a {host} ...",
        "SSH connection failed": "Conexión SSH fallida",
        "SSH connected successfully": "Conexión SSH exitosa",
        "Detecting remote environment...": "Detectando entorno remoto ...",
        "Hermes not installed": "Hermes no instalado",
        "Installing Hermes...": "Instalando Hermes Agent ...",
        "Installation failed": "Instalación fallida",
        "Transferring package...": "Transfiriendo paquete a {host} ...",
        "Transfer complete ({size})": "Transferido ({size})",
        "Remote restore failed": "Restauración remota fallida",
        "Deployment complete!": "¡Despliegue completo!",
        "Target '{name}' does not exist": "El destino '{name}' no existe",
        "Target '{name}' added: {host}": "Destino '{name}' agregado: {host}",
        "No targets registered": "No hay destinos registrados",
        "Registered targets ({count}):": "Destinos registrados ({count}):",
        "Starting Web GUI...": "Iniciando interfaz Web ...",
        "GUI available at http://{host}:{port}": "Interfaz disponible en http://{host}:{port}",
        "Input your SSH key path": "Ingrese la ruta de su clave SSH",
        "Input your remote host": "Ingrese su host remoto",
        "Skip sensitive files": "Saltar archivos sensibles",
        "Exclude .env and auth.json": "Excluir .env y auth.json",
        "Preview mode --dry-run": "Modo previsualización --dry-run",
        "Would restore {count} files": "Restauraría {count} archivos",
        "No files will be written": "No se escribirá ningún archivo",
        "Run without --dry-run to execute": "Ejecute sin --dry-run para proceder",
    },
    # Korean
    "ko": {
        "backup": "백업",
        ...
        "cancel": "취소",
        "package": "패키지",
        "Scanning {path} ...": "{path} 검색 중 ...",
        "No files to backup": "백업할 파일이 없습니다",
        "Packaging {count} files ...": "{count}개 파일 패키징 중 ...",
        "Backup complete: {path}": "패키징 완료: {path}",
        "Files: {count}": "파일 수: {count}",
        "Original size: {size}": "원본 크기: {size}",
        "Compressed size: {size}": "압축 크기: {size}",
        "Compression ratio: {ratio}%": "압축률: {ratio}%",
        "Time: {elapsed}s": "시간: {elapsed}초",
        "Sensitive files: {status}": "민감 파일: {status}",
        "Restore with: hermes-transfer.py restore {name}": "복원 명령: hermes-transfer.py restore {name}",
        "Restore complete: {count} files in {elapsed}s": "복원 완료: {count}개 파일, {elapsed}초 소요",
        "Integrity check: {verified}/{total} passed": "무결성 검사: {verified}/{total} 통과",
        "Warning: {count} errors": "경고 ({count}개):",
        "Deploying to {host}": "{host}에 배포 중",
        "Testing SSH connection to {host}...": "{host}에 SSH 연결 테스트 중 ...",
        "SSH connection failed": "SSH 연결 실패",
        "SSH connected successfully": "SSH 연결 성공",
        "Detecting remote environment...": "원격 환경 감지 중 ...",
        "Hermes not installed": "Hermes가 설치되지 않았습니다",
        "Installing Hermes...": "Hermes Agent 설치 중 ...",
        "Installation failed": "설치 실패",
        "Transferring package...": "{host}에 패키지 전송 중 ...",
        "Transfer complete ({size})": "전송 완료 ({size})",
        "Remote restore failed": "원격 복원 실패",
        "Deployment complete!": "배포 완료!",
        "Target '{name}' does not exist": "대상 '{name}'이(가) 존재하지 않습니다",
        "Target '{name}' added: {host}": "대상 '{name}' 추가됨: {host}",
        "No targets registered": "등록된 대상이 없습니다",
        "Registered targets ({count}):": "등록된 대상 ({count}개):",
        "Starting Web GUI...": "Web GUI 시작 중 ...",
        "GUI available at http://{host}:{port}": "GUI 접속: http://{host}:{port}",
        "Input your SSH key path": "SSH 키 경로 입력",
        "Input your remote host": "원격 호스트 입력",
        "Skip sensitive files": "민감 파일 건너뛰기",
        "Exclude .env and auth.json": ".env 및 auth.json 제외",
        "Preview mode --dry-run": "미리보기 모드 --dry-run",
        "Would restore {count} files": "{count}개 파일을 복원합니다",
        "No files will be written": "파일이 기록되지 않습니다",
        "Run without --dry-run to execute": "--dry-run 없이 실행하세요",
    },
}

def _(key: str) -> str:
    """Look up a translated string. Falls back to key (English) if not found."""
    return _STR.get(LANG, {}).get(key, key)
...
def cmd_pack(args: argparse.Namespace):
    ...
    print()
    print(f"✅ {_('Backup complete')}: {out_path}")
    print(f"   {_('Files')}:    {len(files_to_add)}")
    print(f"   {_('Original size')}:  {_fmt_size(total_original)}")
    print(f"   {_('Compressed size')}:  {_fmt_size(pkg_size)}")
    print(f"   {_('Compression ratio')}:    {pkg_size / total_original * 100:.1f}%")
    print(f"   {_('Time')}:      {elapsed:.1f}s")
    print(f"   {_('Sensitive files')}: {'⚠️ ' + _('Yes') if manifest['sensitive_included'] else _('No')}")
    print()
    print(f"   {_('Restore with')}: hermes-transfer.py restore {out_path.name}")
...
def cmd_apply(args: argparse.Namespace):
    ...
    with zipfile.ZipFile(pkg_path, "r") as zf:
        ...
        print()
        print(f"✅ {_('Restore complete: {count} files in {elapsed}s').format(count=restored, elapsed=f'{elapsed:.1f}')}")
        print(f"   {_('Target')}: {HERMES_HOME}")
        if verified:
...
def main():
    parser = argparse.ArgumentParser(
        ...
        description=_("Hermes Agent memory transfer & deploy tool v") + REVIVE_VERSION,
